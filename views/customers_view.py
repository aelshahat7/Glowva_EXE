...
class CustomersView(ctk.CTkFrame):
    ...
    def _refresh_list(self):
        ...
        if not customers:
            ctk.CTkLabel(self.list_frame, text="مفيش عملاء يطابقوا البحث", text_color="gray50").pack(pady=30)
            return
    ...
    def _render_row(self, customer):
        row = ctk.CTkButton(
            ...
            anchor="e", command=lambda: self._open_detail(customer)
        )
